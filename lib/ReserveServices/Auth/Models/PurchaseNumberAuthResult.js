...
const MkknInfoResult_1 = require("./MkknInfoResult");
const YkknInfoResult_1 = require("./YkknInfoResult");
/**
 * 購入管理番号認証out
                ...
                if (property !== null && property.hasOwnProperty('YkknInfo')) {
                    if (Array.isArray(property.YkknInfo)) {
                        for (const info of property.YkknInfo) {
                            ykknInfos.push(YkknInfoResult_1.default.parse(info));
                        }
                    }
                    else {
                        ykknInfos.push(YkknInfoResult_1.default.parse(property.YkknInfo));
                    }
                }
                ...
                if (property !== null && property.hasOwnProperty('MkknInfo')) {
                    if (Array.isArray(property.MkknInfo)) {
                        for (const info of property.MkknInfo) {
                            mkknInfos.push(MkknInfoResult_1.default.parse(info));
                        }
                    }
                    else {
                        mkknInfos.push(MkknInfoResult_1.default.parse(property.MkknInfo));
                    }
                }
