            ...
            if (normalizedName === 'knshkmmisiInfo') {
                ...
                if (Array.isArray(property.KnshkmmisiInfo)) {
                    for (const info of property.KnshkmmisiInfo) {
                        types.push(TicketInfoTypeResult_1.TicketInfoTypeResult.parse(info));
                    }
                }
                else {
                    types.push(TicketInfoTypeResult_1.TicketInfoTypeResult.parse(property.KnshkmmisiInfo));
                }
                ...
                if (property !== null && property.hasOwnProperty('KnshInfo')) {
                    if (Array.isArray(property.KnshInfo)) {
                        ...
                        types.push(TicketInfoTypeResult_1.TicketInfoTypeResult.parse(property.KnshInfo));
                    }
                }
                result[normalizedName] = types;
            }
...
exports.TicketInfoResult = TicketInfoResult;
