...
export default class RegisterMemberService extends Service {
     ...
     */
    public registerMemberTemporary(params: Object) {
     ...
     */
    public sendMemberTemporaryCompletionMail(kiinCd: string) {
     ...
     */
    public registerMemberProperly(hmbntrkyUrl: string, kiintrkdvcTyp: string) {
