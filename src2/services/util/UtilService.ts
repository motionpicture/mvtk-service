...
export default class UtilService extends Service {
     ...
     */
    public createQrCode(knyknrNo, pinCd) {
     ...
     * @param {Object} values
     */
    public encryptDataList(params: Object) {
        ...
        return new Promise<{
            ...
            this.call(method, args, (err, response, result) => {
                ...
                let encryptedStrings: string[] = null;
     ...
     */
    public getCodeName(kmkTyp: string, typ: string, blnkarFlg: string) {
